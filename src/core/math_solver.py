...
class MathematicalSolver:
    ...
    def solve_problem(self, question_text: str, options: List[str] = None) -> MathSolution:
    ...
    def _solve_logarithm_problem(self, question_text: str, options: List[str] = None) -> MathSolution:
    ...
    def _solve_quadratic_problem(self, question_text: str, options: List[str] = None) -> MathSolution:
        ...
        steps.append(MathStep(
            ...
            equation="x = (-b ± √Δ) / (2a)",
            result=f"x = {solutions[0]}, x = {solutions[1]}" if len(solutions) == 2 else f"x = {solutions[0]}",
    ...
    def _solve_system_linear(self, question_text: str, options: List[str] = None) -> MathSolution:
    ...
    def _solve_percentage_problem(self, question_text: str, options: List[str] = None) -> MathSolution:
    ...
    def _solve_ratio_problem(self, question_text: str, options: List[str] = None) -> MathSolution:
    ...
    def _solve_general_problem(self, question_text: str, options: List[str] = None) -> MathSolution:
    ...
    def _fallback_solution(self, problem_type: str, question_text: str, options: List[str] = None) -> MathSolution:
